    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('raw_material', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='raw_materials.RawMaterial', verbose_name='Raw Material')),
                ('sale', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.Sale', verbose_name='Sale')),
            ],
            options={
                'verbose_name': 'Raw Material Sale Relation',
                'verbose_name_plural': 'Raw Material Sale Relations',
            },
        ),
    ]
